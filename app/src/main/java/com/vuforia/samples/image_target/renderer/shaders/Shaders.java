...
public class Shaders {
    ...
    public static final String CUBE_MESH_VERTEX_SHADER = " \n" + "\n"
            ...
            + "    normal = n_normal; \n"
            + "    vec3 n_vertexPosition = vertexPosition; \n"
            + "    n_vertexPosition.x = vertexPosition.x + vertexPositionOffset.x; \n"
            + "    n_vertexPosition.y = vertexPosition.y + vertexPositionOffset.y; \n"
            + "    n_vertexPosition.z = vertexPosition.z + vertexPositionOffset.z; \n"
